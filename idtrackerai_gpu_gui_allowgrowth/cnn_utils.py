###############################################################################
# This is an adaptation of the script cnn_utils.py part
# of the idtrackerai package.
#
# It was slightly modified in order to set the allow_growth parameter of
# tensorflow to True. This avoids crashes when the GPU is used concurrently by
# other processes, at a possible performance cost.
#
...
###############################################################################
# Saul's patch for avoiding crashes when the GPU is concurrently used by other
# processes
